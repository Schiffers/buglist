...
class StoreEntry
{
	public:
		...
		StoreEntry(const std::string& _name, const StoreOfferState_t& _state, const std::string& _description, const StringVec& _icons) {
			name = _name;
			state = _state;
			description = _description;
			icons = _icons;
...
{
	public:
		StoreCategory(const std::string& _name, const StoreOfferState_t& _state, const std::string& _description, const StringVec& _icons) :
